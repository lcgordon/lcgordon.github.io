...
const WindowSystem = {
    ...
    getWindowSize(type) {
        ...
        const sizes = {
            ...
            phd: { width: window.innerWidth - 700, height: window.innerHeight - 170},
    ...
    getWindowPosition(size, type) {
        ...
        if (type == 'phd') {
           return {
            x: 350 + (this.windows.length * 20),
            y: 20 + (this.windows.length * 20)
           }
        }
